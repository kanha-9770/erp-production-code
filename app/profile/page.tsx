...
export default function DashboardPage() {
  ...
  // Force refetch every time the page mounts to ensure fresh data
  useEffect(() => {
    refetch();
  }, [refetch]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 shadow-sm flex justify-between items-center py-1.5 px-4 sm:px-6 lg:px-8">
            ...
            <CardContent className="pt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                <Link href="/profile/update-profile" className="w-full">
                  <Button variant="outline" className="h-8 w-full justify-start px-3">
                ...
                <Link href="/profile/email-preferences" className="w-full">
                  <Button variant="outline" className="h-8 w-full justify-start px-3">
