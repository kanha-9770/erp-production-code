...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      // Handle password related errors from backend
      if (status === 400 && 
        ...
        toast({
          ...
          description: serverMessage || "Please choose a stronger password",
          variant: "destructive",
        })
        return
      }
      ...
      if (status === 400) {
        toast({
          ...
          description: serverMessage || "Please check the information you entered",
          variant: "destructive",
        })
        return
      }
