  ...
  return (
    <div className="flex-1 space-y-8 p-4 sm:p-6 lg:p-8 pb-12">
      ...
      <div className="rounded-xl border bg-card shadow-sm">
        <div className="px-4 sm:px-6 py-4 flex flex-wrap items-center gap-x-4 gap-y-3">
        ...
        {timeFilter === "custom" && (
          <div className="px-4 sm:px-6 pb-4 flex flex-wrap items-center gap-2.5 border-t pt-4">
