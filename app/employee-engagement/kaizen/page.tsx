  ...
  return (
    <>
      ...
      <Sheet open={createOpen} onOpenChange={setCreateOpen}>
        <SheetContent side="right" resizable defaultWidth={896} hideClose className="w-full overflow-y-auto p-0 flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            <FieldWrapper label="Employee ID" required error={showErr("employeeId") ? errors.employeeId : ""}>
              <Input
                ...
                disabled
                aria-readonly
                className={`bg-muted/40 cursor-not-allowed${showErr("employeeId") ? " border-red-500" : ""}`}
              />
            </FieldWrapper>
            ...
            <FieldWrapper label="Department">
              <Select value={formData.department} disabled>
                <SelectTrigger className="bg-muted/40 cursor-not-allowed"><SelectValue placeholder="Select an option" /></SelectTrigger>
                <SelectContent>
