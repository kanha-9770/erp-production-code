...
const SOURCING_SEED: Array<Record<string, unknown>> = [
  { docNo: "RFQ-0001", docDate: "2026-05-08", prRef: "PR-0001", supplier: "Nessco Fasteners", itemName: "M8 x 25 Hex Bolt", quantity: 2000, uom: "PC", quotedRate: 4.2, leadTimeDays: 7, paymentTerms: "Net 30", status: "SELECTED" },
  { docNo: "RFQ-0002", docDate: "2026-05-08", prRef: "PR-0001", supplier: "Gupta Hardware Co.", itemName: "M8 x 25 Hex Bolt", quantity: 2000, uom: "PC", quotedRate: 4.6, leadTimeDays: 4, paymentTerms: "Advance", status: "QUOTED" },
  { docNo: "RFQ-0003", docDate: "2026-05-10", prRef: "PR-0002", supplier: "Apex Pneumatics", itemName: "Hydraulic Oil 68", quantity: 200, uom: "LTR", quotedRate: 205, leadTimeDays: 3, paymentTerms: "Net 15", status: "NEGOTIATION" },
];

const PO_SEED: Array<Record<string, unknown>> = [
  { docNo: "PO-0001", docDate: "2026-05-12", supplier: "Nessco Fasteners", rfqRef: "RFQ-0001", itemName: "M8 x 25 Hex Bolt", quantity: 2000, uom: "PC", rate: 4.2, amount: 8400, paymentTerms: "Net 30", deliveryDate: "2026-05-19", approvalStatus: "APPROVED", status: "GENERATED" },
  { docNo: "PO-0002", docDate: "2026-05-13", supplier: "Apex Pneumatics", rfqRef: "RFQ-0003", itemName: "Hydraulic Oil 68", quantity: 200, uom: "LTR", rate: 205, amount: 41000, paymentTerms: "Net 15", deliveryDate: "2026-05-16", approvalStatus: "PENDING", status: "PENDING_APPROVAL" },
  { docNo: "PO-0003", docDate: "2026-05-13", supplier: "Gupta Hardware Co.", rfqRef: "PR-0001", itemName: "M10 Flat Washer", quantity: 500, uom: "PC", rate: 3, amount: 1500, paymentTerms: "Advance", deliveryDate: "2026-05-22", approvalStatus: "APPROVED", status: "GENERATED" },
  { docNo: "PO-0004", docDate: "2026-05-13", supplier: "Precision Tools Pvt Ltd", rfqRef: "PR-0001", itemName: "Spring Washer", quantity: 1000, uom: "PC", rate: 1.2, amount: 1200, paymentTerms: "Advance", deliveryDate: "2026-05-20", approvalStatus: "APPROVED", status: "GENERATED" },
  { docNo: "PO-0005", docDate: "2026-05-14", supplier: "Metro Electricals", rfqRef: "PR-0003", itemName: "Cable Gland 20mm", quantity: 300, uom: "PC", rate: 18, amount: 5400, paymentTerms: "Net 30", deliveryDate: "2026-05-24", approvalStatus: "PENDING", status: "PENDING_APPROVAL" },
];
...
const PAYMENT_SEED: Array<Record<string, unknown>> = [
  { docNo: "PAY-0001", docDate: "2026-05-20", supplier: "Nessco Fasteners", poRef: "PO-0001", invoiceNo: "INV-NF-3321", invoiceAmount: 8316, paymentTerms: "Net 30", dueDate: "2026-06-19", status: "APPROVED" },
  { docNo: "PAY-0002", docDate: "2026-05-21", supplier: "Apex Pneumatics", poRef: "PO-0002", invoiceNo: "INV-AP-1180", invoiceAmount: 41000, paymentTerms: "Net 15", dueDate: "2026-05-31", status: "REQUESTED" },
];

const SUPPLIER_SEED: Array<Record<string, unknown>> = [
  { docNo: "SUP-0001", supplierName: "Sharma Steels", supplierType: "COMPANY", supplierGroup: "Raw Material - Metal", status: "ACTIVE", contactPerson: "Rakesh Sharma", phone: "+91 98290 11223", email: "sales@sharmasteels.in", city: "Jaipur", state: "Rajasthan", country: "India", pincode: "302013", gstin: "08ABCDS1234F1Z5", pan: "ABCDS1234F", paymentTerms: "Net 30", currency: "INR", creditDays: 30, creditLimit: 500000, rating: "A", bankName: "HDFC Bank", accountNo: "50100123456789", ifsc: "HDFC0001234", bankBranch: "MI Road" },
  { docNo: "SUP-0002", supplierName: "Nessco Fasteners", supplierType: "COMPANY", supplierGroup: "Hardware", status: "ACTIVE", contactPerson: "Amit Gupta", phone: "+91 99100 44556", email: "info@nesscofasteners.com", city: "Jaipur", state: "Rajasthan", country: "India", pincode: "302022", gstin: "08NESSC6789K1Z2", pan: "NESSC6789K", paymentTerms: "Net 30", currency: "INR", creditDays: 30, creditLimit: 300000, rating: "A", bankName: "ICICI Bank", accountNo: "001401512345", ifsc: "ICIC0000014", bankBranch: "Vaishali Nagar" },
  { docNo: "SUP-0003", supplierName: "Apex Pneumatics", supplierType: "PROPRIETORSHIP", supplierGroup: "Pneumatic", status: "ACTIVE", contactPerson: "S. Khan", phone: "+91 98765 33445", email: "apex.pneumatics@gmail.com", city: "Mumbai", state: "Maharashtra", country: "India", pincode: "400072", gstin: "27APEXP4567L1Z9", pan: "APEXP4567L", paymentTerms: "Net 15", currency: "INR", creditDays: 15, creditLimit: 200000, rating: "B", bankName: "Axis Bank", accountNo: "918020012345", ifsc: "UTIB0000123", bankBranch: "Andheri" },
  { docNo: "SUP-0004", supplierName: "Metro Electricals", supplierType: "PARTNERSHIP", supplierGroup: "Electrical", status: "HOLD", contactPerson: "Vijay Rao", phone: "+91 90040 55667", email: "purchase@metroelectricals.in", city: "Pune", state: "Maharashtra", country: "India", pincode: "411019", gstin: "27METRO8901M1Z1", pan: "METRO8901M", paymentTerms: "Advance", currency: "INR", creditDays: 0, creditLimit: 0, rating: "C" },
  { docNo: "SUP-0005", supplierName: "Gupta Hardware Co.", supplierType: "PROPRIETORSHIP", supplierGroup: "Hardware", status: "ACTIVE", contactPerson: "Mahesh Gupta", phone: "+91 93100 77889", email: "guptahardware@yahoo.com", city: "Delhi", state: "Delhi", country: "India", pincode: "110006", gstin: "07GUPTA2345N1Z7", pan: "GUPTA2345N", paymentTerms: "Advance", currency: "INR", creditDays: 0, creditLimit: 100000, rating: "B" },
  { docNo: "SUP-0006", supplierName: "Precision Tools Pvt Ltd", supplierType: "COMPANY", supplierGroup: "Tool", status: "ACTIVE", contactPerson: "N. Iyer", phone: "+91 98455 99001", email: "sales@precisiontools.co.in", city: "Bengaluru", state: "Karnataka", country: "India", pincode: "560058", gstin: "29PRECI6789P1Z3", pan: "PRECI6789P", paymentTerms: "Net 45", currency: "INR", creditDays: 45, creditLimit: 750000, rating: "A", bankName: "SBI", accountNo: "32145678901", ifsc: "SBIN0001234", bankBranch: "Peenya" },
  { docNo: "SUP-0007", supplierName: "Speedways Logistics", supplierType: "COMPANY", supplierGroup: "Repair Work", status: "INACTIVE", contactPerson: "Ravi Menon", phone: "+91 90000 12121", email: "ops@speedways.in", city: "Mumbai", state: "Maharashtra", country: "India", pincode: "400001", gstin: "27SPEED1212Q1Z4", pan: "SPEED1212Q", paymentTerms: "Net 30", currency: "INR", rating: "C" },
];
