...
//   // NEW: Track module count to auto-select newly created module instantly
...
//       // A new module was just created via optimistic update
//       setSelectedModule(modules[modules.length - 1]); // last one is the newly added one
...
//                     <Button
//                       variant="outline"
//                       onClick={() => openSubmodule(selectedModule)}
//                     >
