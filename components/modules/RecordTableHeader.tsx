  ...
  return (
    <>
      ...
      >
        ...
        {/* Serial Number */}
        <div className="w-12 h-8 border-r border-gray-300 bg-slate-100 flex items-center justify-center text-xs font-bold text-gray-800 flex-shrink-0">
          #
        </div>

        {/* Actions Column Header */}
        <div className="w-20 sm:w-24 h-8 border-r border-gray-300 bg-slate-100 flex items-center justify-center text-xs font-bold text-gray-800 flex-shrink-0">
          Actions
        </div>
          ...
          <React.Fragment key={formGroup.id}>
            {formGroup.directSections.map((sec) => (
              <div
                ...
                className="h-8 bg-gray-200 flex items-center justify-center text-sm font-bold text-gray-800 border-r border-gray-300"
