      ...
      >
        <div className={cn("w-full h-full flex items-center", isWrapTextEnabled || isExpanded ? "items-start py-2" : "")}>
          {isEditing ? (
            ...
            <a href={locationUrl} target="_blank" rel="noopener noreferrer" className="w-full h-full text-blue-600 hover:text-blue-700 hover:underline flex items-center gap-2 group/link" onClick={(e) => e.stopPropagation()} title={`Open ${displayText} in Google Maps`}>
