...
//       console.log("[v0] Triggering records refresh from formsContent")
//       setTimeout(() => {
...
//           {/* Calculate how many empty cells needed on the LEFT to push content right */}
//           {(() => {
//             const visibleCount = Math.min(forms.length, 2)
//             const filterTakesOne = hasMore ? 1 : 0
//             const totalOccupied = visibleCount + filterTakesOne
//             const emptyLeft = 6 - totalOccupied

//             return Array.from({ length: emptyLeft }).map((_, i) => (
//               <div key={`empty-left-${i}`} className="col-span-1" />
//             ))
//           })()}

//           {/* Render up to 2 visible forms, right before the filter */}
//           {visible.map((f) => (
...
//           {/* Filter button (funnel) - always on the far right if hasMore */}
//           {hasMore && (
