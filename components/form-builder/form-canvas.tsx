...
//         {/* ── Header: stacks vertically on mobile, row on desktop ── */}
...
//           {/* Toggle + badge + spinner — row on both, wraps naturally on mobile */}
...
//                   onAddSubform={addSubformUnderSection}
//                 />

//                 {/* ── Subforms under section:
//                       mobile  → no left margin, thin left border, less padding
//                       desktop → original ml-8 pl-6 ── */}
...
//               <div key={subform.id} className="mt-6 sm:mt-8">
//                 <SubformComponent
//                   subform={subform}
//                   onUpdateSubform={(updates) => updateSubform(subform.id, updates)}
//                   onDeleteSubform={() => deleteSubform(subform.id)}
...
//           </div>
//         ) : (
//           <Card className="border-2 border-dashed p-8 sm:p-12 text-center bg-gray-50/50">
//             <CardContent>
//               <Layers className="h-12 w-12 sm:h-16 sm:w-16 text-muted-foreground/30 mx-auto mb-4" />
//               <h3 className="text-lg sm:text-xl font-semibold text-gray-700">Start building</h3>
//               <p className="text-sm text-gray-500 mb-6">
//                 Create a section or a table-style subform
//               </p>
//             </CardContent>
//           </Card>
//         )}

//         {/* ── Bottom action buttons: stack on mobile, row on desktop ── */}
//         <div className="flex flex-col gap-3 mt-8 sm:flex-row sm:gap-4 sm:mt-12">
//           <Button
//             onClick={addSection}
//             disabled={isAddingSection}
//             className="w-full py-6 sm:py-8 border-gray-300 hover:border-blue-400 hover:bg-blue-50"
//             variant="outline"
//           >
//             {isAddingSection ? (
...
//             ) : (
//               <>
//                 <Plus className="mr-2 h-5 w-5" /> Add Subform
//               </>
//             )}
//           </Button>
//         </div>
...
//   }
//   onFormUpdate: (form: FormCanvasProps["form"]) => void
//   // ✅ NEW PROP - This is the key
//   hasOtherEmployeeForm: boolean
// }

// export default function FormCanvas({ 
//   form, 
//   onFormUpdate, 
//   hasOtherEmployeeForm   // ← Receive the prop
// }: FormCanvasProps) {
...
//   // Unified list: sections and top-level subforms interleaved by order
...
//           {/* ✅ FIXED TOGGLE BUTTON - This is the main change */}
//           <div className="flex items-center gap-3 flex-wrap">
//             {/* Show toggle only if no other form is Employee Form OR this form is the Employee Form */}
...
//         {/* Unified rendering: sections and subforms interleaved by order */}
//         {(form.sections?.length || topLevelSubforms.length) ? (
//           <SortableContext
...
//                 disabled={isAddingSection}
//                 variant="outline"
//                 className="border-slate-200 hover:border-blue-400 hover:bg-blue-50/50"
//               >
...
//                 disabled={isAddingSubform}
//                 variant="outline"
//                 className="border-slate-200 hover:border-violet-400 hover:bg-violet-50/50"
//               >
...
//           {/* Toggle Button - Correct Logic as per your requirement */}
//           <div className="flex items-center gap-3 flex-wrap">
//             {/* Show toggle button when:
//                 - No other form is Employee Form, OR
//                 - This form is the Employee Form */}
//             {(!hasOtherEmployeeForm || isEmployeeForm) && (
//               <div className="flex items-center space-x-3">
//                 <Switch
//                   id="employee-form-toggle"
