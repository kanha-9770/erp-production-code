...
//     ],
//     features: {
//       autoFillFromZip: true,
//       hideableSubfields: true,
//     },
//   },
//   {
//     id: "name",
...
//   // ── Mobile-only toggle state — not used on desktop at all ──
...
//         {/* Expandable panel — slides up when open */}
//         {mobileOpen && (
//           <div
...
export const fieldTypes = [
  ...
  },
  {
    ...
    icon: Hash,
    category: "Basic",
    description: "Percentage input field (only numbers allowed)",
    percentConfig: {
      min: 0,
      max: 100,
      decimals: 2,
  ...
  const { attributes, listeners, setNodeRef, transform, isDragging } =
    useDraggable({
      ...
      data: {
        ...
        // Pass percentConfig when dragging percent field
        ...(fieldType.id === "percent" && {
          percentConfig: (fieldType as any).percentConfig,
        }),
      },
    });
