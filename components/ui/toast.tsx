...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Top-centre on every viewport. Bottom-right was getting missed for
      // destructive toasts (face mismatch, validation errors) because users'
      // attention sits near the centre of the page; pinning to the top-centre
      // makes critical messages unmissable without becoming modal-blocking.
