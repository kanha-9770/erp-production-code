...
//       // Force refresh of selectedModule with latest data from the hook
//       // This is the key fix to make the new form appear immediately
//       setTimeout(() => {
//         const latestModule = modules.find((m) => m.id === selectedModule.id);
//         if (latestModule) {
//           setSelectedModule({ ...latestModule });
//         }
//       }, 50); // Small delay ensures the optimistic hook has updated modules
