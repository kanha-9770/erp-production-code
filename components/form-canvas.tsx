...
//     // - Create new field via API with same properties
//     // - Increment order
//     // - Add to appropriate section/subform
//   };

//   // NEW: Field settings handler
...
//   // PERFORMANCE FIX: Optimistic section addition with correct order
...
//           {form.description && <p className="text-gray-500 mt-2 text-sm">{form.description}</p>}
//         </div>
...
// import { Card, CardContent } from "@/components/ui/card"
// import { Button } from "@/components/ui/button"
// import { Plus, Layers, Loader2, UserCheck } from "lucide-react"
// import SectionComponent from "./section-component"
// import SubformComponent from "./subform-component"
...
//   // ────────────────────────────────────────────────
//   const [showConfirmEmployee, setShowConfirmEmployee] = useState(false)
//   const [isTogglingEmployee, setIsTogglingEmployee] = useState(false)

//   const isEmployeeForm = form?.isEmployeeForm || false

//   const toggleEmployeeForm = async (checked: boolean) => {
//     if (!form) return

//     if (checked && form.recordCount && form.recordCount > 0) {
//       // Show confirmation only when enabling and form has records
//       setShowConfirmEmployee(true)
//       return
//     }
...
//       isUserForm: false, // always disable user form if setting employee
//       updatedAt: new Date(),
//     }
...
//       toast({
//         title: makeEmployee ? "Employee Form Enabled" : "Employee Form Disabled",
//         description: makeEmployee
//           ? "This form is now designated as an Employee Form."
//           : "Form reverted to regular form.",
//       })
//     } catch (err) {
//       console.error("Toggle employee form error:", err)
//       // Rollback on error
//       onFormUpdate(form)
//       toast({
//         title: "Error",
...
//                 onCheckedChange={toggleEmployeeForm}
...
//             {isEmployeeForm && (
//               <Badge variant="secondary" className="bg-green-100 text-green-800 border-green-200 px-3 py-1 text-xs font-medium flex items-center gap-1">
...
//         <AlertDialog open={showConfirmEmployee} onOpenChange={setShowConfirmEmployee}>
//           <AlertDialogContent>
//             <AlertDialogHeader>
//               <AlertDialogTitle>Convert to Employee Form?</AlertDialogTitle>
//               <AlertDialogDescription className="space-y-3">
//                 <p>
//                   This form already contains <strong>{form?.recordCount || 0}</strong> record(s).
//                 </p>
//                 <p>
//                   Enabling <strong>Employee Form</strong> mode will:
//                 </p>
//                 <ul className="list-disc pl-5 space-y-1">
//                   <li>Store <strong>new</strong> submissions in the dedicated employee forms table</li>
//                   <li>Enable employee-specific features and validations</li>
//                   <li>Automatically disable User Form mode if it was enabled</li>
//                 </ul>
//                 <p className="text-sm text-amber-800 mt-3">
//                   <strong>Existing records</strong> will remain in their current storage location.
//                 </p>
