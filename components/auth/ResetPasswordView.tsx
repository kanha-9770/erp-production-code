      ...
      <div className="w-full max-w-md">
        <Card>
          <CardContent className="pt-6 text-center">
            ...
            <Button onClick={() => onSwitchView("forgot-password")}>Request Password Reset</Button>
          </CardContent>
        </Card>
      </div>
    )
  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-600">Enter the code from your email and set a new password</p>
      </div>
